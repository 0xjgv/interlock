...
from interlock.config import find_project_root, kv_with_source, load_config
from interlock.detect import expected_target_interpreter
from interlock.setup_state import (
...
if TYPE_CHECKING:
    ...
    from interlock.ui import State
