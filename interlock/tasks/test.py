...
wrappers guard on the same ``None`` signal. Mirrors ``interlock.tasks.acceptance``.
"""

from __future__ import annotations

from interlock.config import build_test_command, load_config
from interlock.runner import Task, run, warn_skip
